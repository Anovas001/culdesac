...
const optionalText = (minimum: number, maximum: number) => z.preprocess(
  (value) => value ?? "",
  z.string()
    .trim()
...
export const tournamentSchema = z.object({
  ...
  rules: z.string().trim().min(3).max(10000),
  nameEs: optionalText(3, 120),
  headlineEs: optionalText(3, 160),
  descriptionEs: optionalText(10, 5000),
  rulesEs: optionalText(3, 10000),
